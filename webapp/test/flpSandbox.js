		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SmartForm Print using PDF preview",
									"targetURL": "#smartformprint-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smartformprint-display": {
								"semanticObject": "smartformprint",
								"action": "display",
								"description": "SmartForm Print using PDF preview",
								"title": "SmartForm Print using PDF preview",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smartformprint",
									"url": sap.ui.require.toUrl("smartformprint")
								}
							}
						}
					}
